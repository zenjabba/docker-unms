...
FROM ubnt/unms:0.14.3 as unms
FROM ubnt/unms-netflow:0.14.3 as unms-netflow
...
ADD https://github.com/Ubiquiti-App/UNMS/archive/v0.14.3.tar.gz /tmp/unms.tar.gz
